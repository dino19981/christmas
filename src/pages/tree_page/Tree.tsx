  ...
  return (
    <main className="main">
      <section className="section-tree">
        ...
        <button onClick={() => handleOptions(options)} className="mobile__left-options button">Настройки</button>
        <button onClick={() => handleOptions(toys)} className="mobile__left-toys button">Игрушки</button>
